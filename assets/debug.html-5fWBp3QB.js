...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面例子中，函数 <code>func1</code> 是在 <code>main.sh</code> 的第 7 行调用，函数 <code>func2</code> 是在 <code>lib1.sh</code> 的第 8 行调用的。</p>`,33);function k(h,g){const e=c("RouterLink");return l(),o("div",null,[r,t(" more "),v,s("p",null,[n("另外，"),b,n(" 命令也可以设置 Shell 的行为参数，有利于脚本除错，详见 "),p(e,{to:"/linux/bash/set.html"},{default:d(()=>[n("set 命令")]),_:1}),n(" 一章。")]),m])}const E=i(u,[["render",k],["__file","debug.html.vue"]]);export{E as default};
